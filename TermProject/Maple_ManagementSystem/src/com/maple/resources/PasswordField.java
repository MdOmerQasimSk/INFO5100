...
public class PasswordField extends JPasswordField {
    ...
    public PasswordField() {
        ...
        eye = new ImageIcon(getClass().getResource("/com/maple/resources/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/com/maple/resources/eye_hide.png")).getImage();
