...
public class ViewJPanel extends javax.swing.JPanel {
    ...
    public void displayProfile(){
        jFirstName.setText(profile.getFirstName());
        jLastName.setText(profile.getLastName());
        jDateOfBirth.setText(profile.getDateOfBirth());
        jAge.setText(profile.getAge());
        jTelNum.setText(profile.getTelNum());
        jEmail.setText(profile.getEmail());
        jAddress1.setText(profile.getpAddress());
        jAddress2.setText(profile.getsAddress());
        jCity.setText(profile.getCity());
        jCountry.setText(profile.getCountry());
        jAffiliation.setText(profile.getAffiliation());
        jMajor.setText(profile.getMajor());
        jCareer.setText(profile.getCareer());
        jDegree1.setText(profile.getPrimaryDegree());
        jDegree1Start.setText(profile.getpDegreeStart());
        jDegree1End.setText(profile.getpDegreeEnd());
        jDegree2.setText(profile.getSecondaryDegree());
        jDegree2Start.setText(profile.getsDegreeStart());
        jDegree2End.setText(profile.getsDegreeEnd());
        ...
        if(profile.getFirstName() != null && profile.getLastName() != null){
            jUserName.setText(profile.getFirstName() + " " + profile.getLastName() + "!");
        }
